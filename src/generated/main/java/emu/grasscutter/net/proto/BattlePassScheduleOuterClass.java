...
public final class BattlePassScheduleOuterClass {
  ...
  public interface BattlePassScheduleOrBuilder extends
    ...
    /**
     * <code>.BattlePassCycle cur_cycle = 14;</code>
    ...
    /**
     * <code>uint32 cur_cycle_points = 3;</code>
     * @return The curCyclePoints.
     */
    int getCurCyclePoints();

    /**
     * <code>uint32 JPFMGBEBBBJ = 6;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int CUR_CYCLE_FIELD_NUMBER = 14;
    ...
    public static final int CUR_CYCLE_POINTS_FIELD_NUMBER = 3;
    ...
    public static final int JPFMGBEBBBJ_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (curCyclePoints_ != 0) {
        output.writeUInt32(3, curCyclePoints_);
      }
      ...
      if (jPFMGBEBBBJ_ != 0) {
        output.writeUInt32(6, jPFMGBEBBBJ_);
      }
      if (point_ != 0) {
      ...
      if (curCycle_ != null) {
        output.writeMessage(14, getCurCycle());
      }
    ...
    public int getSerializedSize() {
      ...
      if (curCyclePoints_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, curCyclePoints_);
      }
      for (int i = 0; i < rewardTakenList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (jPFMGBEBBBJ_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(6, jPFMGBEBBBJ_);
      }
      if (point_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (curCycle_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(14, getCurCycle());
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "hedule_id\030\014 \001(\r\022\r\n\005level\030\n \001(\r\022\r\n\005point\030" +
      "\007 \001(\r\022.\n\runlock_status\030\005 \001(\0162\027.BattlePas" +
      "sUnlockStatus\022/\n\021reward_taken_list\030\004 \003(\013" +
      "2\024.BattlePassRewardTag\022\022\n\nbegin_time\030\t \001" +
      "(\r\022\020\n\010end_time\030\001 \001(\r\022#\n\tcur_cycle\030\016 \001(\0132" +
      "\020.BattlePassCycle\022\"\n\032is_extra_paid_rewar" +
      "d_taken\030\010 \001(\010\022(\n\014product_info\030\r \001(\0132\022.Ba" +
      "ttlePassProduct\022\021\n\tis_viewed\030\013 \001(\010\022\030\n\020cu" +
      "r_cycle_points\030\003 \001(\r\022\023\n\013JPFMGBEBBBJ\030\006 \001(" +

...
public final class ScenePlayerLocationNotifyOuterClass {
  ...
  public interface ScenePlayerLocationNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .PlayerLocationInfo player_loc_list = 8;</code>
     */
    ...
    /**
     * <code>repeated .VehicleLocationInfo vehicle_loc_list = 5;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    /**
     * Protobuf enum {@code ScenePlayerLocationNotify.CmdId}
     */
    public enum CmdId
      ...
      NONE(0, 0),
      /**
       * <code>ENET_CHANNEL_ID = 1;</code>
       */
      ENET_CHANNEL_ID(1, 1),
      /**
       * <code>CMD_ID = 207;</code>
       */
      CMD_ID(3, 207),
      UNRECOGNIZED(-1, -1),
      ;
       ...
       */
      public static final CmdId ENET_IS_RELIABLE = ENET_CHANNEL_ID;
      /**
       * <code>NONE = 0;</code>
       */
       ...
       * <code>ENET_CHANNEL_ID = 1;</code>
       */
      public static final int ENET_CHANNEL_ID_VALUE = 1;
      /**
       * <code>ENET_IS_RELIABLE = 1;</code>
       */
       ...
       * <code>CMD_ID = 207;</code>
       */
      public static final int CMD_ID_VALUE = 207;
      ...
      public static CmdId forNumber(int value) {
        switch (value) {
          case 0: return NONE;
          case 1: return ENET_CHANNEL_ID;
          case 207: return CMD_ID;
          default: return null;
        }
      }
      ...
      // @@protoc_insertion_point(enum_scope:ScenePlayerLocationNotify.CmdId)
    }
    ...
    public static final int PLAYER_LOC_LIST_FIELD_NUMBER = 8;
    ...
    public static final int VEHICLE_LOC_LIST_FIELD_NUMBER = 5;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < vehicleLocList_.size(); i++) {
        output.writeMessage(5, vehicleLocList_.get(i));
      }
      for (int i = 0; i < playerLocList_.size(); i++) {
        output.writeMessage(8, playerLocList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < vehicleLocList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, vehicleLocList_.get(i));
      }
      for (int i = 0; i < playerLocList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(8, playerLocList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "scene_id\030\001 \001(\r\022,\n\017player_loc_list\030\010 \003(\0132" +
      "\023.PlayerLocationInfo\022.\n\020vehicle_loc_list" +
      "\030\005 \003(\0132\024.VehicleLocationInfo\"M\n\005CmdId\022\010\n" +
      "\004NONE\020\000\022\023\n\017ENET_CHANNEL_ID\020\001\022\024\n\020ENET_IS_" +
      "RELIABLE\020\001\022\013\n\006CMD_ID\020\317\001\032\002\020\001B\033\n\031emu.grass" +

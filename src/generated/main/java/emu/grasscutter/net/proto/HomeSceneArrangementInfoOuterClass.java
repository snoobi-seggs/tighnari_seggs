...
public final class HomeSceneArrangementInfoOuterClass {
  ...
  public interface HomeSceneArrangementInfoOrBuilder extends
    ...
    /**
     * <code>repeated .HomeBlockArrangementInfo block_arrangement_info_list = 11;</code>
     */
    ...
    /**
     * <code>bool is_set_born_pos = 3;</code>
    ...
    /**
     * <code>uint32 CNLMNOEGKME = 15;</code>
     * @return The cNLMNOEGKME.
     */
    int getCNLMNOEGKME();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int BLOCK_ARRANGEMENT_INFO_LIST_FIELD_NUMBER = 11;
    ...
    public static final int IS_SET_BORN_POS_FIELD_NUMBER = 3;
    ...
    public static final int DJINN_POS_FIELD_NUMBER = 7;
    ...
    public static final int CNLMNOEGKME_FIELD_NUMBER = 15;
    private int cNLMNOEGKME_;
    /**
     * <code>uint32 CNLMNOEGKME = 15;</code>
     * @return The cNLMNOEGKME.
     */
    @java.lang.Override
    public int getCNLMNOEGKME() {
      return cNLMNOEGKME_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (isSetBornPos_ != false) {
        output.writeBool(3, isSetBornPos_);
      }
      if (bornPos_ != null) {
      ...
      if (djinnPos_ != null) {
        output.writeMessage(7, getDjinnPos());
      }
      ...
      for (int i = 0; i < blockArrangementInfoList_.size(); i++) {
        output.writeMessage(11, blockArrangementInfoList_.get(i));
      }
      if (tmpVersion_ != 0) {
      ...
      if (cNLMNOEGKME_ != 0) {
        output.writeUInt32(15, cNLMNOEGKME_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (isSetBornPos_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(3, isSetBornPos_);
      }
      if (bornPos_ != null) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (djinnPos_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, getDjinnPos());
      }
      for (int i = 0; i < doorList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
      ...
      for (int i = 0; i < blockArrangementInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(11, blockArrangementInfoList_.get(i));
      }
      if (tmpVersion_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (cNLMNOEGKME_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(15, cNLMNOEGKME_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getCNLMNOEGKME()
          != other.getCNLMNOEGKME()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + CNLMNOEGKME_FIELD_NUMBER;
      hash = (53 * hash) + getCNLMNOEGKME();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.HomeSceneArrangementInfoOuterClass.HomeSceneArrangementInfo buildPartial() {
        ...
        result.cNLMNOEGKME_ = cNLMNOEGKME_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.HomeSceneArrangementInfoOuterClass.HomeSceneArrangementInfo other) {
        ...
        if (other.getCNLMNOEGKME() != 0) {
          setCNLMNOEGKME(other.getCNLMNOEGKME());
        }
      ...
      /**
       * <code>uint32 CNLMNOEGKME = 15;</code>
       * @param value The cNLMNOEGKME to set.
       * @return This builder for chaining.
       */
      public Builder setCNLMNOEGKME(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearCNLMNOEGKME() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ata.proto\032\014Vector.proto\"\217\003\n\030HomeSceneArr" +
      "angementInfo\022\020\n\010scene_id\030\n \001(\r\022>\n\033block_" +
      "arrangement_info_list\030\013 \003(\0132\031.HomeBlockA" +
      "rrangementInfo\022\027\n\017is_set_born_pos\030\003 \001(\010\022" +
      "\031\n\010born_pos\030\005 \001(\0132\007.Vector\022\031\n\010born_rot\030\001" +
      " \001(\0132\007.Vector\022%\n\tdoor_list\030\010 \003(\0132\022.HomeF" +
      "urnitureData\022&\n\nstair_list\030\006 \003(\0132\022.HomeF" +
      "urnitureData\022&\n\nmain_house\030\t \001(\0132\022.HomeF" +
      "urnitureData\022\025\n\rcomfort_value\030\r \001(\r\022\032\n\td" +
      "jinn_pos\030\007 \001(\0132\007.Vector\022\023\n\013tmp_version\030\014" +
      " \001(\r\022\023\n\013CNLMNOEGKME\030\017 \001(\rB\033\n\031emu.grasscu" +
    ...
    internal_static_HomeSceneArrangementInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_HomeSceneArrangementInfo_descriptor,
        new java.lang.String[] { "SceneId", "BlockArrangementInfoList", "IsSetBornPos", "BornPos", "BornRot", "DoorList", "StairList", "MainHouse", "ComfortValue", "DjinnPos", "TmpVersion", "CNLMNOEGKME", });
    emu.grasscutter.net.proto.HomeBlockArrangementInfoOuterClass.getDescriptor();
    emu.grasscutter.net.proto.HomeFurnitureDataOuterClass.getDescriptor();
    emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
  }

...
public final class WidgetActiveChangeNotifyOuterClass {
  ...
  public interface WidgetActiveChangeNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .WidgetSlotData widget_data_list = 4;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int WIDGET_DATA_LIST_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < widgetDataList_.size(); i++) {
        output.writeMessage(4, widgetDataList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < widgetDataList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, widgetDataList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "fy\022)\n\020widget_data_list\030\004 \003(\0132\017.WidgetSlo" +

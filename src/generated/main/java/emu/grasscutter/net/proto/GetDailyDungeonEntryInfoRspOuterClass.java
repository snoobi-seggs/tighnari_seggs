...
public final class GetDailyDungeonEntryInfoRspOuterClass {
  ...
  public interface GetDailyDungeonEntryInfoRspOrBuilder extends
    ...
    /**
     * <code>repeated .DailyDungeonEntryInfo daily_dungeon_info_list = 4;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int DAILY_DUNGEON_INFO_LIST_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < dailyDungeonInfoList_.size(); i++) {
        output.writeMessage(4, dailyDungeonInfoList_.get(i));
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < dailyDungeonInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, dailyDungeonInfoList_.get(i));
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "eonEntryInfoRsp\022\017\n\007retcode\030\t \001(\005\0227\n\027dail" +
      "y_dungeon_info_list\030\004 \003(\0132\026.DailyDungeon" +

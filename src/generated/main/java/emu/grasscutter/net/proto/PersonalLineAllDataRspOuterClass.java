...
public final class PersonalLineAllDataRspOuterClass {
  ...
  public interface PersonalLineAllDataRspOrBuilder extends
    ...
    /**
     * <code>uint32 cur_finished_daily_task_count = 4;</code>
    ...
    /**
     * <code>repeated uint32 ongoing_personal_line_list = 13;</code>
    ...
    /**
     * <code>repeated .LockedPersonallineData locked_personal_line_list = 14;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int CUR_FINISHED_DAILY_TASK_COUNT_FIELD_NUMBER = 4;
    ...
    public static final int ONGOING_PERSONAL_LINE_LIST_FIELD_NUMBER = 13;
    ...
    public static final int LOCKED_PERSONAL_LINE_LIST_FIELD_NUMBER = 14;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (curFinishedDailyTaskCount_ != 0) {
        output.writeUInt32(4, curFinishedDailyTaskCount_);
      }
      ...
      for (int i = 0; i < lockedPersonalLineList_.size(); i++) {
        output.writeMessage(14, lockedPersonalLineList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      if (curFinishedDailyTaskCount_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, curFinishedDailyTaskCount_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < canBeUnlockedPersonalLineList_.size(); i++) {
      ...
      for (int i = 0; i < lockedPersonalLineList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(14, lockedPersonalLineList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_daily_task_count\030\004 \001(\r\022\033\n\023legendary_key" +
      ...
      "t\030\016 \003(\0132\027.LockedPersonallineDataB\033\n\031emu." +

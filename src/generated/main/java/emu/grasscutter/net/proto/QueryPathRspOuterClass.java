...
public final class QueryPathRspOuterClass {
  ...
  public interface QueryPathRspOrBuilder extends
    ...
    /**
     * <code>.QueryPathRsp.PathStatusType query_status = 5;</code>
    ...
    /**
     * <code>repeated .Vector corners = 12;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < corners_.size(); i++) {
        output.writeMessage(12, corners_.get(i));
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < corners_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(12, corners_.get(i));
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\002 \001(\005\0222\n\014query_status\030\005 \001(\0162\034.QueryPath" +
      "Rsp.PathStatusType\022\030\n\007corners\030\014 \003(\0132\007.Ve" +

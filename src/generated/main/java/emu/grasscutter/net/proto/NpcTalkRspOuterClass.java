...
public final class NpcTalkRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    /**
     * Protobuf enum {@code NpcTalkRsp.CmdId}
     */
    public enum CmdId
       ...
       * <code>CMD_ID = 531;</code>
       */
      public static final int CMD_ID_VALUE = 531;
      ...
      // @@protoc_insertion_point(enum_scope:NpcTalkRsp.CmdId)
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (curTalkId_ != 0) {
        output.writeUInt32(6, curTalkId_);
      }
      if (entityId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (curTalkId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(6, curTalkId_);
      }
      if (entityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream

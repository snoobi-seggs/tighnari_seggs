...
public final class RoguelikeDungeonSettleInfoOuterClass {
  ...
  public interface RoguelikeDungeonSettleInfoOrBuilder extends
    ...
    /**
     * <code>bool is_final_level = 4;</code>
     * @return The isFinalLevel.
     */
    boolean getIsFinalLevel();

    /**
     * <code>uint32 total_coin_b_num = 5;</code>
     * @return The totalCoinBNum.
     */
    int getTotalCoinBNum();

    /**
     * <code>uint32 total_coin_c_num = 6;</code>
     * @return The totalCoinCNum.
     */
    int getTotalCoinCNum();

    /**
     * <code>bool is_coin_c_reach_limit = 7;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int IS_FINAL_LEVEL_FIELD_NUMBER = 4;
    ...
    public static final int TOTAL_COIN_B_NUM_FIELD_NUMBER = 5;
    ...
    public static final int TOTAL_COIN_C_NUM_FIELD_NUMBER = 6;
    ...
    public static final int IS_COIN_C_REACH_LIMIT_FIELD_NUMBER = 7;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (isFinalLevel_ != false) {
        output.writeBool(4, isFinalLevel_);
      }
      if (totalCoinBNum_ != 0) {
        output.writeUInt32(5, totalCoinBNum_);
      }
      if (totalCoinCNum_ != 0) {
        output.writeUInt32(6, totalCoinCNum_);
      }
      if (isCoinCReachLimit_ != false) {
        output.writeBool(7, isCoinCReachLimit_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (isFinalLevel_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(4, isFinalLevel_);
      }
      if (totalCoinBNum_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, totalCoinBNum_);
      }
      if (totalCoinCNum_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(6, totalCoinCNum_);
      }
      if (isCoinCReachLimit_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(7, isCoinCReachLimit_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "r_level\030\002 \001(\r\022e\n\037finished_challenge_cell" +
      "_num_map\030\003 \003(\0132<.RoguelikeDungeonSettleI" +
      "nfo.FinishedChallengeCellNumMapEntry\022\026\n\016" +
      "is_final_level\030\004 \001(\010\022\030\n\020total_coin_b_num" +
      "\030\005 \001(\r\022\030\n\020total_coin_c_num\030\006 \001(\r\022\035\n\025is_c" +
      "oin_c_reach_limit\030\007 \001(\010\032\\\n FinishedChall" +
    ...
    internal_static_RoguelikeDungeonSettleInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_RoguelikeDungeonSettleInfo_descriptor,
        new java.lang.String[] { "StageId", "CurLevel", "FinishedChallengeCellNumMap", "IsFinalLevel", "TotalCoinBNum", "TotalCoinCNum", "IsCoinCReachLimit", });
    internal_static_RoguelikeDungeonSettleInfo_FinishedChallengeCellNumMapEntry_descriptor =

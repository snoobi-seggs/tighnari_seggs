...
public final class HitCollisionOuterClass {
  ...
  public interface HitCollisionOrBuilder extends
    ...
    /**
     * <code>float attackee_hit_force_angle = 14;</code>
     * @return The attackeeHitForceAngle.
     */
    float getAttackeeHitForceAngle();

    /**
     * <code>float attackee_hit_entity_angle = 8;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ATTACKEE_HIT_FORCE_ANGLE_FIELD_NUMBER = 14;
    ...
    public static final int ATTACKEE_HIT_ENTITY_ANGLE_FIELD_NUMBER = 8;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (attackeeHitEntityAngle_ != 0F) {
        output.writeFloat(8, attackeeHitEntityAngle_);
      }
      ...
      if (attackeeHitForceAngle_ != 0F) {
        output.writeFloat(14, attackeeHitForceAngle_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (attackeeHitEntityAngle_ != 0F) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(8, attackeeHitEntityAngle_);
      }
      if (hitColliderType_ != emu.grasscutter.net.proto.HitColliderTypeOuterClass.HitColliderType.HIT_COLLIDER_TYPE_INVALID.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (attackeeHitForceAngle_ != 0F) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(14, attackeeHitForceAngle_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\025\n\rhit_box_index\030\001 \001(\005\022\032\n\thit_point\030\013 \001(" +
      "\0132\007.Vector\022\030\n\007hit_dir\030\005 \001(\0132\007.Vector\022 \n\030" +
      "attackee_hit_force_angle\030\016 \001(\002\022!\n\031attack" +
      "ee_hit_entity_angle\030\010 \001(\002B\033\n\031emu.grasscu" +
    ...
    internal_static_HitCollision_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_HitCollision_descriptor,
        new java.lang.String[] { "HitColliderType", "HitBoxIndex", "HitPoint", "HitDir", "AttackeeHitForceAngle", "AttackeeHitEntityAngle", });
    emu.grasscutter.net.proto.HitColliderTypeOuterClass.getDescriptor();
    emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
  }

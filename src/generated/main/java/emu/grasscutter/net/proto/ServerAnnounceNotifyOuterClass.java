...
public final class ServerAnnounceNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ANNOUNCE_DATA_LIST_FIELD_NUMBER = 8;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < announceDataList_.size(); i++) {
        output.writeMessage(8, announceDataList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < announceDataList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(8, announceDataList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "unce_data_list\030\010 \003(\0132\r.AnnounceDataB\033\n\031e" +

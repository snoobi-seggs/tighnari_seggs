...
public final class TowerMonthlyBriefOuterClass {
  ...
  public interface TowerMonthlyBriefOrBuilder extends
    ...
    /**
     * <code>uint32 best_floor_index = 5;</code>
    ...
    /**
     * <code>uint32 total_star_count = 2;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int BEST_FLOOR_INDEX_FIELD_NUMBER = 5;
    ...
    public static final int TOTAL_STAR_COUNT_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (totalStarCount_ != 0) {
        output.writeUInt32(2, totalStarCount_);
      }
      if (towerScheduleId_ != 0) {
        output.writeUInt32(4, towerScheduleId_);
      }
      if (bestFloorIndex_ != 0) {
        output.writeUInt32(5, bestFloorIndex_);
      }
      if (bestLevelIndex_ != 0) {
        output.writeUInt32(12, bestLevelIndex_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (totalStarCount_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, totalStarCount_);
      }
      if (towerScheduleId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (bestFloorIndex_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, bestFloorIndex_);
      }
      if (bestLevelIndex_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(12, bestLevelIndex_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "yBrief\022\031\n\021tower_schedule_id\030\004 \001(\r\022\030\n\020bes" +
      "t_floor_index\030\005 \001(\r\022\030\n\020best_level_index\030" +
      "\014 \001(\r\022\030\n\020total_star_count\030\002 \001(\rB\033\n\031emu.g" +

...
public final class QueryCodexMonsterBeKilledNumRspOuterClass {
  ...
  public interface QueryCodexMonsterBeKilledNumRspOrBuilder extends
    ...
    /**
     * <code>repeated uint32 CHPBKCLKPCJ = 2;</code>
     * @return A list containing the cHPBKCLKPCJ.
     */
    java.util.List<java.lang.Integer> getCHPBKCLKPCJList();
    /**
     * <code>repeated uint32 CHPBKCLKPCJ = 2;</code>
     * @return The count of cHPBKCLKPCJ.
     */
    int getCHPBKCLKPCJCount();
    /**
     * <code>repeated uint32 CHPBKCLKPCJ = 2;</code>
     * @param index The index of the element to return.
     * @return The cHPBKCLKPCJ at the given index.
     */
    int getCHPBKCLKPCJ(int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 16: {
              if (!((mutable_bitField0_ & 0x00000004) != 0)) {
                cHPBKCLKPCJ_ = newIntList();
                mutable_bitField0_ |= 0x00000004;
              }
              cHPBKCLKPCJ_.addInt(input.readUInt32());
              break;
            }
            case 18: {
    ...
    /**
     * Protobuf enum {@code QueryCodexMonsterBeKilledNumRsp.CmdId}
     */
    public enum CmdId
       ...
       * <code>CMD_ID = 4205;</code>
       */
      public static final int CMD_ID_VALUE = 4205;
      ...
      // @@protoc_insertion_point(enum_scope:QueryCodexMonsterBeKilledNumRsp.CmdId)
    }
    ...
    public static final int CHPBKCLKPCJ_FIELD_NUMBER = 2;
    private com.google.protobuf.Internal.IntList cHPBKCLKPCJ_;
    /**
     * <code>repeated uint32 CHPBKCLKPCJ = 2;</code>
     * @return A list containing the cHPBKCLKPCJ.
     */
     ...
     * @return The count of cHPBKCLKPCJ.
     */
    public int getCHPBKCLKPCJCount() {
      return cHPBKCLKPCJ_.size();
    }
    /**
     * <code>repeated uint32 CHPBKCLKPCJ = 2;</code>
     * @param index The index of the element to return.
     * @return The cHPBKCLKPCJ at the given index.
     */
    public int getCHPBKCLKPCJ(int index) {
      return cHPBKCLKPCJ_.getInt(index);
    }
    private int cHPBKCLKPCJMemoizedSerializedSize = -1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (getCHPBKCLKPCJList().size() > 0) {
        output.writeUInt32NoTag(18);
        output.writeUInt32NoTag(cHPBKCLKPCJMemoizedSerializedSize);
      }
      for (int i = 0; i < cHPBKCLKPCJ_.size(); i++) {
        output.writeUInt32NoTag(cHPBKCLKPCJ_.getInt(i));
      }
      ...
      }
      {
        ...
        for (int i = 0; i < cHPBKCLKPCJ_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeUInt32SizeNoTag(cHPBKCLKPCJ_.getInt(i));
        }
        size += dataSize;
        if (!getCHPBKCLKPCJList().isEmpty()) {
          size += 1;
          size += com.google.protobuf.CodedOutputStream
              .computeInt32SizeNoTag(dataSize);
        }
        cHPBKCLKPCJMemoizedSerializedSize = dataSize;
      }
      {
        int dataSize = 0;
        for (int i = 0; i < codexIdList_.size(); i++) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getCHPBKCLKPCJList()
          .equals(other.getCHPBKCLKPCJList())) return false;
    ...
    public int hashCode() {
      ...
      if (getCHPBKCLKPCJCount() > 0) {
        hash = (37 * hash) + CHPBKCLKPCJ_FIELD_NUMBER;
        hash = (53 * hash) + getCHPBKCLKPCJList().hashCode();
      }
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.QueryCodexMonsterBeKilledNumRspOuterClass.QueryCodexMonsterBeKilledNumRsp buildPartial() {
        ...
        if (((bitField0_ & 0x00000004) != 0)) {
          cHPBKCLKPCJ_.makeImmutable();
          bitField0_ = (bitField0_ & ~0x00000004);
        }
        result.cHPBKCLKPCJ_ = cHPBKCLKPCJ_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.QueryCodexMonsterBeKilledNumRspOuterClass.QueryCodexMonsterBeKilledNumRsp other) {
        ...
        if (!other.cHPBKCLKPCJ_.isEmpty()) {
          if (cHPBKCLKPCJ_.isEmpty()) {
            cHPBKCLKPCJ_ = other.cHPBKCLKPCJ_;
            bitField0_ = (bitField0_ & ~0x00000004);
          } else {
            ensureCHPBKCLKPCJIsMutable();
            cHPBKCLKPCJ_.addAll(other.cHPBKCLKPCJ_);
          }
          onChanged();
        }
      ...
      private com.google.protobuf.Internal.IntList cHPBKCLKPCJ_ = emptyIntList();
      private void ensureCHPBKCLKPCJIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          cHPBKCLKPCJ_ = mutableCopy(cHPBKCLKPCJ_);
      ...
      public java.util.List<java.lang.Integer>
        ...
        return ((bitField0_ & 0x00000004) != 0) ?
                 java.util.Collections.unmodifiableList(cHPBKCLKPCJ_) : cHPBKCLKPCJ_;
      }
      /**
       * <code>repeated uint32 CHPBKCLKPCJ = 2;</code>
       * @return The count of cHPBKCLKPCJ.
       ...
       * <code>repeated uint32 CHPBKCLKPCJ = 2;</code>
       * @param index The index to set the value at.
       * @param value The cHPBKCLKPCJ to set.
       * @return This builder for chaining.
       */
      public Builder setCHPBKCLKPCJ(
          int index, int value) {
        ensureCHPBKCLKPCJIsMutable();
        cHPBKCLKPCJ_.setInt(index, value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 CHPBKCLKPCJ = 2;</code>
       * @param value The cHPBKCLKPCJ to add.
       * @return This builder for chaining.
       */
      public Builder addCHPBKCLKPCJ(int value) {
        ensureCHPBKCLKPCJIsMutable();
        cHPBKCLKPCJ_.addInt(value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 CHPBKCLKPCJ = 2;</code>
       * @param values The cHPBKCLKPCJ to add.
       * @return This builder for chaining.
       */
      public Builder addAllCHPBKCLKPCJ(
          java.lang.Iterable<? extends java.lang.Integer> values) {
        ensureCHPBKCLKPCJIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, cHPBKCLKPCJ_);
       ...
       * @return This builder for chaining.
       */
      public Builder clearCHPBKCLKPCJ() {
        cHPBKCLKPCJ_ = emptyIntList();
        bitField0_ = (bitField0_ & ~0x00000004);
        onChanged();
        return this;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\311\001\n\037QueryCodexMonsterBeKilledNumRsp\022\017\n\007r" +
      "etcode\030\001 \001(\005\022\025\n\rcodex_id_list\030\004 \003(\r\022\032\n\022b" +
      "e_killed_num_list\030\013 \003(\r\022\023\n\013CHPBKCLKPCJ\030\002" +
      " \003(\r\"M\n\005CmdId\022\010\n\004NONE\020\000\022\023\n\017ENET_CHANNEL_" +
      "ID\020\000\022\024\n\020ENET_IS_RELIABLE\020\001\022\013\n\006CMD_ID\020\355 \032" +
    ...
    internal_static_QueryCodexMonsterBeKilledNumRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_QueryCodexMonsterBeKilledNumRsp_descriptor,
        new java.lang.String[] { "Retcode", "CodexIdList", "BeKilledNumList", "CHPBKCLKPCJ", });
  }

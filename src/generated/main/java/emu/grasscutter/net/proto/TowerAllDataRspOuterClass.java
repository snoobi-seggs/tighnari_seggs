...
public final class TowerAllDataRspOuterClass {
  ...
  public interface TowerAllDataRspOrBuilder extends
    ...
    /**
     * <code>uint32 daily_floor_id = 9;</code>
     * @return The dailyFloorId.
     */
    int getDailyFloorId();

    /**
     * <code>uint32 daily_level_index = 6;</code>
    ...
    /**
     * <code>map&lt;uint32, uint32&gt; floor_open_time_map = 11;</code>
     */
    ...
    /**
     * <code>uint32 skip_to_floor_index = 3;</code>
     * @return The skipToFloorIndex.
     */
    int getSkipToFloorIndex();

    /**
     * <code>uint32 commemorative_reward_id = 15;</code>
     * @return The commemorativeRewardId.
     */
    int getCommemorativeRewardId();

    /**
     * <code>map&lt;uint32, uint32&gt; skip_floor_granted_reward_item_map = 5;</code>
     */
    ...
    /**
     * <code>uint32 valid_tower_record_num = 10;</code>
    ...
    /**
     * <code>uint32 schedule_start_time = 490;</code>
     * @return The scheduleStartTime.
     */
    int getScheduleStartTime();

    /**
     * <code>.TowerMonthlyBrief last_schedule_monthly_brief = 395;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int DAILY_FLOOR_ID_FIELD_NUMBER = 9;
    ...
    public static final int DAILY_LEVEL_INDEX_FIELD_NUMBER = 6;
    ...
    public static final int FLOOR_OPEN_TIME_MAP_FIELD_NUMBER = 11;
    ...
    public static final int SKIP_TO_FLOOR_INDEX_FIELD_NUMBER = 3;
    ...
    public static final int COMMEMORATIVE_REWARD_ID_FIELD_NUMBER = 15;
    ...
    public static final int SKIP_FLOOR_GRANTED_REWARD_ITEM_MAP_FIELD_NUMBER = 5;
    ...
    public static final int VALID_TOWER_RECORD_NUM_FIELD_NUMBER = 10;
    ...
    public static final int SCHEDULE_START_TIME_FIELD_NUMBER = 490;
    ...
    public static final int LAST_SCHEDULE_MONTHLY_BRIEF_FIELD_NUMBER = 395;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (skipToFloorIndex_ != 0) {
        output.writeUInt32(3, skipToFloorIndex_);
      }
      if (retcode_ != 0) {
      ...
      if (dailyLevelIndex_ != 0) {
        output.writeUInt32(6, dailyLevelIndex_);
      }
      ...
      if (dailyFloorId_ != 0) {
        output.writeUInt32(9, dailyFloorId_);
      }
      if (validTowerRecordNum_ != 0) {
        output.writeUInt32(10, validTowerRecordNum_);
      }
      com.google.protobuf.GeneratedMessageV3
        .serializeIntegerMapTo(
          output,
      ...
      if (commemorativeRewardId_ != 0) {
        output.writeUInt32(15, commemorativeRewardId_);
      }
      if (lastScheduleMonthlyBrief_ != null) {
        output.writeMessage(395, getLastScheduleMonthlyBrief());
      }
      if (scheduleStartTime_ != 0) {
        output.writeUInt32(490, scheduleStartTime_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (skipToFloorIndex_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, skipToFloorIndex_);
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> entry
        ...
        skipFloorGrantedRewardItemMap__ = SkipFloorGrantedRewardItemMapDefaultEntryHolder.defaultEntry.newBuilderForType()
            ...
            .build();
        size += com.google.protobuf.CodedOutputStream
            .computeMessageSize(5, skipFloorGrantedRewardItemMap__);
      }
      if (dailyLevelIndex_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(6, dailyLevelIndex_);
      }
      if (isFinishedEntranceFloor_ != false) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (dailyFloorId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(9, dailyFloorId_);
      }
      if (validTowerRecordNum_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, validTowerRecordNum_);
      }
      for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> entry
        ...
        floorOpenTimeMap__ = FloorOpenTimeMapDefaultEntryHolder.defaultEntry.newBuilderForType()
            ...
            .build();
        size += com.google.protobuf.CodedOutputStream
            .computeMessageSize(11, floorOpenTimeMap__);
      }
      for (int i = 0; i < towerFloorRecordList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (commemorativeRewardId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(15, commemorativeRewardId_);
      }
      if (lastScheduleMonthlyBrief_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(395, getLastScheduleMonthlyBrief());
      }
      if (scheduleStartTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(490, scheduleStartTime_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\031\n\021tower_schedule_id\030\r \001(\r\0222\n\027tower_floo" +
      "r_record_list\030\014 \003(\0132\021.TowerFloorRecord\022\026" +
      "\n\016daily_floor_id\030\t \001(\r\022\031\n\021daily_level_in" +
      "dex\030\006 \001(\r\022.\n\020cur_level_record\030\002 \001(\0132\024.To" +
      "werCurLevelRecord\022!\n\031next_schedule_chang" +
      "e_time\030\010 \001(\r\022C\n\023floor_open_time_map\030\013 \003(" +
      "\0132&.TowerAllDataRsp.FloorOpenTimeMapEntr" +
      "y\022\031\n\021is_first_interact\030\016 \001(\010\022)\n\rmonthly_" +
      "brief\030\001 \001(\0132\022.TowerMonthlyBrief\022\033\n\023skip_" +
      "to_floor_index\030\003 \001(\r\022\037\n\027commemorative_re" +
      "ward_id\030\017 \001(\r\022_\n\"skip_floor_granted_rewa" +
      "rd_item_map\030\005 \003(\01323.TowerAllDataRsp.Skip" +
      "FloorGrantedRewardItemMapEntry\022\036\n\026valid_" +
      "tower_record_num\030\n \001(\r\022\017\n\007retcode\030\004 \001(\005\022" +
      "\"\n\032is_finished_entrance_floor\030\007 \001(\010\022\034\n\023s" +
      "chedule_start_time\030\352\003 \001(\r\0228\n\033last_schedu" +
      "le_monthly_brief\030\213\003 \001(\0132\022.TowerMonthlyBr" +
      "ief\0327\n\025FloorOpenTimeMapEntry\022\013\n\003key\030\001 \001(" +
      "\r\022\r\n\005value\030\002 \001(\r:\0028\001\032D\n\"SkipFloorGranted" +
      "RewardItemMapEntry\022\013\n\003key\030\001 \001(\r\022\r\n\005value" +

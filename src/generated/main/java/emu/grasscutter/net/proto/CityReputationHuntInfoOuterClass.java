...
public final class CityReputationHuntInfoOuterClass {
  ...
  public interface CityReputationHuntInfoOrBuilder extends
    ...
    /**
     * <code>bool hasReward = 12;</code>
     * @return The hasReward.
     */
    boolean getHasReward();

    /**
     * <code>uint32 curWeekFinishNum = 6;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int HASREWARD_FIELD_NUMBER = 12;
    ...
    public static final int CURWEEKFINISHNUM_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (curWeekFinishNum_ != 0) {
        output.writeUInt32(6, curWeekFinishNum_);
      }
      if (isOpen_ != false) {
        output.writeBool(8, isOpen_);
      }
      if (hasReward_ != false) {
        output.writeBool(12, hasReward_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (curWeekFinishNum_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(6, curWeekFinishNum_);
      }
      if (isOpen_ != false) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "putationHuntInfo\022\016\n\006isOpen\030\010 \001(\010\022\021\n\thasR" +
      "eward\030\014 \001(\010\022\030\n\020curWeekFinishNum\030\006 \001(\rB\033\n" +

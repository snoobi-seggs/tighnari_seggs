...
public final class WidgetReportReqOuterClass {
  ...
  public interface WidgetReportReqOrBuilder extends
    ...
    /**
     * <code>bool is_client_collect = 9;</code>
     * @return The isClientCollect.
     */
    boolean getIsClientCollect();

    /**
     * <code>bool ICBFJGOLNOL = 1;</code>
     * @return The iCBFJGOLNOL.
     */
    boolean getICBFJGOLNOL();
  }
  /**
   * <pre>
   * CmdId: 4287
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int IS_CLIENT_COLLECT_FIELD_NUMBER = 9;
    ...
    public static final int ICBFJGOLNOL_FIELD_NUMBER = 1;
    private boolean iCBFJGOLNOL_;
    /**
     * <code>bool ICBFJGOLNOL = 1;</code>
     * @return The iCBFJGOLNOL.
     */
    @java.lang.Override
    public boolean getICBFJGOLNOL() {
      return iCBFJGOLNOL_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (iCBFJGOLNOL_ != false) {
        output.writeBool(1, iCBFJGOLNOL_);
      }
      if (materialId_ != 0) {
        output.writeUInt32(7, materialId_);
      }
      if (isClientCollect_ != false) {
        output.writeBool(9, isClientCollect_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (iCBFJGOLNOL_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(1, iCBFJGOLNOL_);
      }
      if (materialId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (isClientCollect_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(9, isClientCollect_);
      }
      if (isClearHint_ != false) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getICBFJGOLNOL()
          != other.getICBFJGOLNOL()) return false;
    ...
    public int hashCode() {
      ...
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getIsClientCollect());
      hash = (37 * hash) + ICBFJGOLNOL_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getICBFJGOLNOL());
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.WidgetReportReqOuterClass.WidgetReportReq buildPartial() {
        ...
        result.iCBFJGOLNOL_ = iCBFJGOLNOL_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.WidgetReportReqOuterClass.WidgetReportReq other) {
        ...
        if (other.getICBFJGOLNOL() != false) {
          setICBFJGOLNOL(other.getICBFJGOLNOL());
        }
      ...
      /**
       * <code>bool ICBFJGOLNOL = 1;</code>
       * @param value The iCBFJGOLNOL to set.
       * @return This builder for chaining.
       */
      public Builder setICBFJGOLNOL(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearICBFJGOLNOL() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\025WidgetReportReq.proto\"m\n\017WidgetReportR" +
      "eq\022\023\n\013material_id\030\007 \001(\r\022\025\n\ris_clear_hint" +
      "\030\r \001(\010\022\031\n\021is_client_collect\030\t \001(\010\022\023\n\013ICB" +
      "FJGOLNOL\030\001 \001(\010B\033\n\031emu.grasscutter.net.pr" +
      "otob\006proto3"
    };
    ...
    internal_static_WidgetReportReq_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_WidgetReportReq_descriptor,
        new java.lang.String[] { "MaterialId", "IsClearHint", "IsClientCollect", "ICBFJGOLNOL", });
  }

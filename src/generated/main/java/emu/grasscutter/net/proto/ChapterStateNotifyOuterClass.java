...
public final class ChapterStateNotifyOuterClass {
  ...
  public interface ChapterStateNotifyOrBuilder extends
    ...
    /**
     * <code>.ChapterState chapter_state = 12;</code>
    ...
    /**
     * <code>.ChapterStateNotify.NeedBeginTime need_begin_time = 14;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public interface NeedPlayerLevelOrBuilder extends
      ...
      /**
       * <code>bool is_limit = 3;</code>
       * @return The isLimit.
       */
      boolean getIsLimit();

      /**
       * <code>uint32 config_need_player_level = 10;</code>
    ...
    private static final long serialVersionUID = 0L;
      ...
      public static final int IS_LIMIT_FIELD_NUMBER = 3;
      ...
      public static final int CONFIG_NEED_PLAYER_LEVEL_FIELD_NUMBER = 10;
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output)
        ...
        if (isLimit_ != false) {
          output.writeBool(3, isLimit_);
        }
        if (configNeedPlayerLevel_ != 0) {
          output.writeUInt32(10, configNeedPlayerLevel_);
        }
      ...
      public int getSerializedSize() {
        ...
        if (isLimit_ != false) {
          size += com.google.protobuf.CodedOutputStream
            .computeBoolSize(3, isLimit_);
        }
        if (configNeedPlayerLevel_ != 0) {
          size += com.google.protobuf.CodedOutputStream
            .computeUInt32Size(10, configNeedPlayerLevel_);
        }
    ...
    public interface NeedBeginTimeOrBuilder extends
      ...
      /**
       * <code>uint32 config_need_begin_time = 6;</code>
    ...
    private static final long serialVersionUID = 0L;
      ...
      public static final int CONFIG_NEED_BEGIN_TIME_FIELD_NUMBER = 6;
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output)
        ...
        if (configNeedBeginTime_ != 0) {
          output.writeUInt32(6, configNeedBeginTime_);
        }
        if (isLimit_ != false) {
      ...
      public int getSerializedSize() {
        ...
        if (configNeedBeginTime_ != 0) {
          size += com.google.protobuf.CodedOutputStream
            .computeUInt32Size(6, configNeedBeginTime_);
        }
        if (isLimit_ != false) {
          size += com.google.protobuf.CodedOutputStream
    ...
    public static final int CHAPTER_STATE_FIELD_NUMBER = 12;
    ...
    public static final int NEED_BEGIN_TIME_FIELD_NUMBER = 14;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (chapterState_ != emu.grasscutter.net.proto.ChapterStateOuterClass.ChapterState.CHAPTER_STATE_INVALID.getNumber()) {
        output.writeEnum(12, chapterState_);
      }
      if (needBeginTime_ != null) {
        output.writeMessage(14, getNeedBeginTime());
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (chapterState_ != emu.grasscutter.net.proto.ChapterStateOuterClass.ChapterState.CHAPTER_STATE_INVALID.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
          .computeEnumSize(12, chapterState_);
      }
      if (needBeginTime_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(14, getNeedBeginTime());
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_id\030\001 \001(\r\022$\n\rchapter_state\030\014 \001(\0162\r.Chapt" +
      "erState\022>\n\021need_player_level\030\n \001(\0132#.Cha" +
      "pterStateNotify.NeedPlayerLevel\022:\n\017need_" +
      "begin_time\030\016 \001(\0132!.ChapterStateNotify.Ne" +
      "edBeginTime\032E\n\017NeedPlayerLevel\022\020\n\010is_lim" +
      "it\030\003 \001(\010\022 \n\030config_need_player_level\030\n \001" +
      "(\r\032A\n\rNeedBeginTime\022\020\n\010is_limit\030\r \001(\010\022\036\n" +
      "\026config_need_begin_time\030\006 \001(\rB\033\n\031emu.gra" +

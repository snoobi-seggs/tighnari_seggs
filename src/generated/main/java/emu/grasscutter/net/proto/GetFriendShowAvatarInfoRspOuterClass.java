...
public final class GetFriendShowAvatarInfoRspOuterClass {
  ...
  public interface GetFriendShowAvatarInfoRspOrBuilder extends
    ...
    /**
     * <code>repeated .ShowAvatarInfo show_avatar_info_list = 7;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    /**
     * Protobuf enum {@code GetFriendShowAvatarInfoRsp.CmdId}
     */
    public enum CmdId
       ...
       * <code>CMD_ID = 4034;</code>
       */
      public static final int CMD_ID_VALUE = 4034;
      ...
      // @@protoc_insertion_point(enum_scope:GetFriendShowAvatarInfoRsp.CmdId)
    }
    ...
    public static final int SHOW_AVATAR_INFO_LIST_FIELD_NUMBER = 7;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < showAvatarInfoList_.size(); i++) {
        output.writeMessage(7, showAvatarInfoList_.get(i));
      }
      if (uid_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < showAvatarInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, showAvatarInfoList_.get(i));
      }
      if (uid_ != 0) {
        size += com.google.protobuf.CodedOutputStream

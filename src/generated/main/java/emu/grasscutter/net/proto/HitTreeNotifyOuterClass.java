...
public final class HitTreeNotifyOuterClass {
  ...
  public interface HitTreeNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 unknown_data = 3;</code>
     * @return The unknownData.
     */
    int getUnknownData();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int UNKNOWN_DATA_FIELD_NUMBER = 3;
    private int unknownData_;
    /**
     * <code>uint32 unknown_data = 3;</code>
     * @return The unknownData.
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unknownData_ != 0) {
        output.writeUInt32(3, unknownData_);
      }
      if (treeType_ != 0) {
        output.writeUInt32(4, treeType_);
      }
      if (treePos_ != null) {
        output.writeMessage(13, getTreePos());
      }
    ...
    public int getSerializedSize() {
      ...
      if (unknownData_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, unknownData_);
      }
      if (treeType_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (treePos_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(13, getTreePos());
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnknownData()
          != other.getUnknownData()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNKNOWN_DATA_FIELD_NUMBER;
      hash = (53 * hash) + getUnknownData();
      if (hasTreePos()) {
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.HitTreeNotifyOuterClass.HitTreeNotify other) {
        ...
        if (other.getUnknownData() != 0) {
          setUnknownData(other.getUnknownData());
        }
        if (other.hasTreePos()) {
      ...
      /**
       * <code>uint32 unknown_data = 3;</code>
       * @param value The unknownData to set.
       * @return This builder for chaining.
       */
      public Builder setUnknownData(int value) {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\023HitTreeNotify.proto\032\014Vector.proto\"S\n\rH" +
      "itTreeNotify\022\021\n\ttree_type\030\004 \001(\r\022\024\n\014unkno" +
      "wn_data\030\003 \001(\r\022\031\n\010tree_pos\030\r \001(\0132\007.Vector" +
    ...
    internal_static_HitTreeNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_HitTreeNotify_descriptor,
        new java.lang.String[] { "TreeType", "UnknownData", "TreePos", });
    emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
  }

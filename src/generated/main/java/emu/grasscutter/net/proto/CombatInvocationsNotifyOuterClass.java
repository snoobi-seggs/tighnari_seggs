...
public final class CombatInvocationsNotifyOuterClass {
  ...
  public interface CombatInvocationsNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .CombatInvokeEntry invoke_list = 4;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int INVOKE_LIST_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < invokeList_.size(); i++) {
        output.writeMessage(4, invokeList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < invokeList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, invokeList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ify\022\'\n\013invoke_list\030\004 \003(\0132\022.CombatInvokeE" +

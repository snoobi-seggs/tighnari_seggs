...
public final class SetEntityClientDataNotifyOuterClass {
  ...
  public interface SetEntityClientDataNotifyOrBuilder extends
    ...
    /**
     * <code>.EntityClientData entity_client_data = 1;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    /**
     * Protobuf enum {@code SetEntityClientDataNotify.CmdId}
     */
    public enum CmdId
       ...
       * <code>CMD_ID = 3375;</code>
       */
      public static final int CMD_ID_VALUE = 3375;
      ...
      // @@protoc_insertion_point(enum_scope:SetEntityClientDataNotify.CmdId)
    }
    ...
    public static final int ENTITY_CLIENT_DATA_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (entityClientData_ != null) {
        output.writeMessage(1, getEntityClientData());
      }
      if (entityId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (entityClientData_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, getEntityClientData());
      }
      if (entityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream

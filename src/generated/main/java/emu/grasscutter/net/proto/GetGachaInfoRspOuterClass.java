...
public final class GetGachaInfoRspOuterClass {
  ...
  public interface GetGachaInfoRspOrBuilder extends
    ...
    /**
     * <code>uint32 KKHCOFPEMNJ = 7;</code>
     * @return The kKHCOFPEMNJ.
     */
    int getKKHCOFPEMNJ();

    /**
     * <code>bool LCPFDBAGIEC = 9;</code>
     * @return The lCPFDBAGIEC.
     */
    boolean getLCPFDBAGIEC();
  }
  /**
   * <pre>
   * CmdId: 1531
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 56: {
              ...
              kKHCOFPEMNJ_ = input.readUInt32();
              break;
            }
            case 72: {

              lCPFDBAGIEC_ = input.readBool();
              break;
            }
            case 98: {
    ...
    public static final int KKHCOFPEMNJ_FIELD_NUMBER = 7;
    private int kKHCOFPEMNJ_;
    /**
     * <code>uint32 KKHCOFPEMNJ = 7;</code>
     * @return The kKHCOFPEMNJ.
     */
    @java.lang.Override
    public int getKKHCOFPEMNJ() {
      return kKHCOFPEMNJ_;
    }

    public static final int LCPFDBAGIEC_FIELD_NUMBER = 9;
    private boolean lCPFDBAGIEC_;
    /**
     * <code>bool LCPFDBAGIEC = 9;</code>
     * @return The lCPFDBAGIEC.
     */
    @java.lang.Override
    public boolean getLCPFDBAGIEC() {
      return lCPFDBAGIEC_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (kKHCOFPEMNJ_ != 0) {
        output.writeUInt32(7, kKHCOFPEMNJ_);
      }
      if (lCPFDBAGIEC_ != false) {
        output.writeBool(9, lCPFDBAGIEC_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (kKHCOFPEMNJ_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, kKHCOFPEMNJ_);
      }
      if (lCPFDBAGIEC_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(9, lCPFDBAGIEC_);
      }
      for (int i = 0; i < gachaInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getKKHCOFPEMNJ()
          != other.getKKHCOFPEMNJ()) return false;
      if (getLCPFDBAGIEC()
          != other.getLCPFDBAGIEC()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + KKHCOFPEMNJ_FIELD_NUMBER;
      hash = (53 * hash) + getKKHCOFPEMNJ();
      hash = (37 * hash) + LCPFDBAGIEC_FIELD_NUMBER;
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.GetGachaInfoRspOuterClass.GetGachaInfoRsp buildPartial() {
        ...
        result.kKHCOFPEMNJ_ = kKHCOFPEMNJ_;
        result.lCPFDBAGIEC_ = lCPFDBAGIEC_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.GetGachaInfoRspOuterClass.GetGachaInfoRsp other) {
        ...
        if (other.getKKHCOFPEMNJ() != 0) {
          setKKHCOFPEMNJ(other.getKKHCOFPEMNJ());
        }
        if (other.getLCPFDBAGIEC() != false) {
          setLCPFDBAGIEC(other.getLCPFDBAGIEC());
        }
      ...
      /**
       * <code>uint32 KKHCOFPEMNJ = 7;</code>
       * @param value The kKHCOFPEMNJ to set.
       * @return This builder for chaining.
       */
      public Builder setKKHCOFPEMNJ(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearKKHCOFPEMNJ() {
      ...
      /**
       * <code>bool LCPFDBAGIEC = 9;</code>
       * @param value The lCPFDBAGIEC to set.
       * @return This builder for chaining.
       */
      public Builder setLCPFDBAGIEC(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearLCPFDBAGIEC() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\017gacha_info_list\030\014 \003(\0132\n.GachaInfo\022\024\n\014ga" +
      "cha_random\030\r \001(\r\022\023\n\013KKHCOFPEMNJ\030\007 \001(\r\022\023\n" +
      "\013LCPFDBAGIEC\030\t \001(\010B\033\n\031emu.grasscutter.ne" +
      "t.protob\006proto3"
    };
    ...
    internal_static_GetGachaInfoRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GetGachaInfoRsp_descriptor,
        new java.lang.String[] { "Retcode", "GachaInfoList", "GachaRandom", "KKHCOFPEMNJ", "LCPFDBAGIEC", });
    emu.grasscutter.net.proto.GachaInfoOuterClass.getDescriptor();
  }

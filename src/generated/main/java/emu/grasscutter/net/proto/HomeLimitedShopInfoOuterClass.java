...
public final class HomeLimitedShopInfoOuterClass {
  ...
  public interface HomeLimitedShopInfoOrBuilder extends
    ...
    /**
     * <code>uint32 next_open_time = 5;</code>
     * @return The nextOpenTime.
     */
    int getNextOpenTime();

    /**
     * <code>uint32 next_guest_open_time = 1;</code>
     * @return The nextGuestOpenTime.
     */
    int getNextGuestOpenTime();

    /**
     * <code>uint32 next_close_time = 10;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int NEXT_GUEST_OPEN_TIME_FIELD_NUMBER = 1;
    ...
    public static final int NEXT_CLOSE_TIME_FIELD_NUMBER = 10;
    ...
    public static final int DJINN_ROT_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (nextGuestOpenTime_ != 0) {
        output.writeUInt32(1, nextGuestOpenTime_);
      }
      if (djinnRot_ != null) {
        output.writeMessage(3, getDjinnRot());
      }
      if (nextOpenTime_ != 0) {
        output.writeUInt32(5, nextOpenTime_);
      }
      if (uid_ != 0) {
        output.writeUInt32(6, uid_);
      }
      if (nextCloseTime_ != 0) {
        output.writeUInt32(10, nextCloseTime_);
      }
      if (djinnPos_ != null) {
    ...
    public int getSerializedSize() {
      ...
      if (nextGuestOpenTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, nextGuestOpenTime_);
      }
      if (djinnRot_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, getDjinnRot());
      }
      if (nextOpenTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, nextOpenTime_);
      }
      if (uid_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (nextCloseTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, nextCloseTime_);
      }
      if (djinnPos_ != null) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\016next_open_time\030\005 \001(\r\022\034\n\024next_guest_ope" +
      "n_time\030\001 \001(\r\022\027\n\017next_close_time\030\n \001(\r\022\032\n" +
      "\tdjinn_pos\030\013 \001(\0132\007.Vector\022\032\n\tdjinn_rot\030\003" +
    ...
    internal_static_HomeLimitedShopInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_HomeLimitedShopInfo_descriptor,
        new java.lang.String[] { "Uid", "NextOpenTime", "NextGuestOpenTime", "NextCloseTime", "DjinnPos", "DjinnRot", });
    emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
  }
